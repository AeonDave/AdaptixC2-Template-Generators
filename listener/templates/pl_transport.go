...
func (t *Transport__NAME_CAP__) handleConnection(conn net.Conn, ts Teamserver) {
	...
	err = Unmarshal(recvData, &initMsg)
	if err != nil {
		goto ERR
	}
	...
	case INIT_PACK:
		...
		err := Unmarshal(initMsg.Data, &initPack)
		if err != nil {
			goto ERR
		}
	...
	case EXFIL_CONN:
		...
		err := Unmarshal(initMsg.Data, &exfilPack)
		if err != nil {
			goto ERR
		}
	...
	case JOB_CONN, BOF_CONN:

		var jobPack JobPack
		err := Unmarshal(initMsg.Data, &jobPack)
		if err != nil {
			goto ERR
		}
	...
	case TUNNEL_PACK:
		...
		err := Unmarshal(initMsg.Data, &tunPack)
		if err != nil {
			goto ERR
		}
	...
	case TERMINAL_PACK:
		...
		err := Unmarshal(initMsg.Data, &termPack)
		if err != nil {
			goto ERR
		}
